...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // --- Mobile Friendly PDF Helper & Google Docs Viewer Integration ---
  ...
  const pdfContainers = [
    {
      id: 'komikstar',
      iframeSelector: '#komikstar .comic-iframe-container iframe',
      containerSelector: '#komikstar .comic-iframe-container',
      pdfPath: 'documents/%D0%9A%D0%BE%D0%BC%D0%B8%D0%BA%D1%81.pdf',
      title: 'Білім беру комиксі',
    ...
    {
      id: 'miro',
      iframeSelector: '#miro .comic-iframe-container iframe',
      containerSelector: '#miro .comic-iframe-container',
      pdfPath: 'documents/Miro.pdf',
      title: 'Miro интерактивті тақтасы',
  ...
  pdfContainers.forEach(item => {
    const container = document.querySelector(item.containerSelector);
    const iframe = document.querySelector(item.iframeSelector);
